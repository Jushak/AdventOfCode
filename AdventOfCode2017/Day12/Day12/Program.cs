...
namespace Day12
{
    ...
    {
        public string id;
        public List<ProgramUnit> linkedPrograms;
        public ProgramUnit(string id)
        {
            this.id = id;
            this.linkedPrograms = new List<ProgramUnit>();
        }

        public override bool Equals(object obj)
        {
            return obj is ProgramUnit && string.Equals(id, ((ProgramUnit)obj).id);
        }
