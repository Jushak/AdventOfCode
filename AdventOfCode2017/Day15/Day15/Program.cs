...
namespace Day15
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            {
                GANumber = (GANumber * factorA) % divider;
                GBNumber = (GBNumber * factorB) % divider;

                if ((GANumber & 0xFFFF) == (GBNumber & 0xFFFF))
                {
                    count++;
                }
            }
            Console.WriteLine("Part 1: The final count is: " + count);
            Console.ReadKey();
            Console.WriteLine();
            ...
            Console.WriteLine("Part 2: The final count is: " + count);
            Console.ReadKey();
        }
    }
}
