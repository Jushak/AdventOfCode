...
namespace Day16
{
    class Program
    {
        ...
        {
            int targetLength = 272; // Part 1
            targetLength = 35651584; // Part 2
                        
            var puzzleInput = "10001001100000001";
            //puzzleInput = "10000"; // Debug
            ...
            // Cut away excess data.
            data = data.Substring(0, targetLength);

            Console.WriteLine("Checksum is: "+GenerateChecksum(data));
        }

        // Reverses both the order (first is last etc.) and content (0->1, 1->0) of given bit-string.
        ...
        // Generates checksum from given bit-string.
        public static string GenerateChecksum(string data)
        {
            ...
            while (checksum.Length % 2 == 0)
            {
                ...
                {
                    if (checksum[i] == checksum[i + 1]) newchecksum.Append("1");
